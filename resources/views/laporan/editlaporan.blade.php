...
<main class="p-6">
    ...
    <div class="bg-white p-8 rounded shadow w-full max-w-3xl mx-auto">
        <h3 class="text-md font-semibold mb-4"><i class="fas fa-chart-bar mr-2"></i> Edit Laporan Booking</h3>
        ...
        <form action="{{ route('laporan.update', $laporan->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="kode_booking" id="kode_booking" value="{{ $laporan->kode_booking }}"
            ...
            <div>
                ...
                <input type="text" name="nama_konsumen" id="nama_konsumen" value="{{ $laporan->nama_konsumen }}"
                    class="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-500" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="treatment" id="treatment" value="{{ $laporan->treatment }}"
                    class="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-500" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="therapist" id="therapist" value="{{ $laporan->therapist }}"
                    class="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-500" required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="harga" id="harga" value="{{ $laporan->harga }}"
                    class="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-500" required>
            </div>
            ...
            <div>
                ...
                <input type="text" name="durasi" id="durasi" value="{{ $laporan->durasi }}"
                    class="w-full p-3 border rounded-md focus:ring-2 focus:ring-blue-500" required>
            </div>
