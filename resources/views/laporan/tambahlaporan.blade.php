...
@section('content')
<main class="p-6">
    <h2 class="text-xl font-bold mb-6">Tambah Laporan</h2>
    ...
    <div class="bg-white p-8 rounded shadow w-full max-w-3xl mx-auto">
        ...
        <form action="{{ route('laporan.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex justify-end space-x-4 mt-6">
                <button type="submit"
                    class="bg-green-600 text-white px-6 py-3 rounded-md hover:bg-green-700 focus:ring-2 focus:ring-green-500">
                    Simpan
                </button>
