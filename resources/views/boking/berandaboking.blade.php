...
<body class="bg-gray-100 text-gray-800">
  ...
  <header class="bg-white shadow">
    <div class="container mx-auto px-4 py-2 flex justify-between items-center">
      ...
      <nav class="space-x-6 text-sm font-medium text-gray-700">
        <a href="#" class="hover:text-[#5A7A48]">Beranda</a>
  ...
  <div class="max-w-6xl mx-auto">
    <h2 class="text-center text-xl font-semibold text-gray-800 mb-6 border-b pb-2">Boking</h2>

  <!-- Form Booking -->
  <main class="flex justify-center items-center py-10">
    <div class="bg-[#7D9264] text-white p-8 rounded-xl w-full max-w-md shadow-md">
      <h3 class="text-center text-xl font-semibold text-black mb-6">Input Data Booking</h3>
      
      <form>
        <label for="nama" class="block mb-1 text-sm">Nama Lengkap</label>
        <input type="text" id="nama" name="nama" class="w-full p-2 rounded text-black mb-4">

        <label for="treatment" class="block mb-1 text-sm">Jenis Treatment</label>
        <input type="text" id="treatment" name="treatment" class="w-full p-2 rounded text-black mb-4">

        <label for="tanggal" class="block mb-1 text-sm">Tanggal Treatment</label>
        <input type="date" id="tanggal" name="tanggal" class="w-full p-2 rounded text-black mb-4">

        <label for="jam" class="block mb-1 text-sm">Jam Treatment</label>
        <input type="time" id="jam" name="jam" class="w-full p-2 rounded text-black mb-4">

        <div class="mb-4">
          <label class="block mb-1 text-sm text-white">Therapist:</label>
          <div class="flex items-center space-x-4 text-black">
            <label class="flex items-center">
              <input type="radio" name="therapist" value="Suci" class="mr-1">
              Suci
            </label>
            <label class="flex items-center">
              <input type="radio" name="therapist" value="Dara" class="mr-1">
              Dara
            </label>
          </div>
        </div>
        <button type="submit" class="w-full bg-gray-800 hover:bg-gray-900 text-white py-2 rounded">Proses Pembayaran</button>
      </form>
    </div>
  </main>
</body>
